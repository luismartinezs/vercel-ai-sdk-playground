...
export async function inquire(
  ...
  // here it can be a bit confusing, but we're updating the UI with the result of the inquiry, because we're passing a streamable value as a prop, so it will update
  ...
  await experimental_streamObject({
    ...
    .then(async (result) => {
      // for await...of is designed to work with asynchronous iterables
      // result.partialObjectStream is an AsyncIterableStream
